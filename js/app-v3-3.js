(function () {
  ...
  function planogramFieldLabel(field){ if(field==="line")return "Linea"; if(field==="brand")return "Brand"; return "Fornitore"; }
  ...
  function updatePlanogramOrientationOptions(){ var field=$("planogramCommercialField").value,label=planogramFieldLabel(field),select=$("planogramOrientation"); select.options[0].textContent=label+" per ripiano · Caratteristica sul ripiano";select.options[1].textContent="Caratteristica per ripiano · "+label+" sul ripiano"; }
  ...
  function renderPlanogram(){
    ...
    var layout=P.buildPlanogram(state.results.rows,{level:level,commercialField:commercialField,orientation:orientation});
