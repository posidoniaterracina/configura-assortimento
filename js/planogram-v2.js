(function (global) {
  ...
  function commercialConfig(field) {
  ...
  function prepareRows(rows, level, commercialField) {
    var config = commercialConfig(commercialField);
  ...
  function buildPlanogram(rows, options) {
    ...
    var commercialField = options.commercialField === "line" || options.commercialField === "brand" ? options.commercialField : "supplier";
    var orientation = options.orientation === "characteristic" ? "characteristic" : "commercial";
    var config = commercialConfig(commercialField);
    var prepared = prepareRows(rows, level, commercialField);
    return {
      level: level,
